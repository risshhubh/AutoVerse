...
const StatusHeader = () => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-30 pointer-events-none mix-blend-difference text-pastel-blue dark:text-pastel-light">
            ...
            <div className="container mx-auto px-6 h-24 flex items-start justify-between pt-6">
                ...
                <div className="w-1/3 flex flex-col items-center justify-start space-y-1">
                ...
                <div className="w-1/3 flex flex-col items-end justify-start pr-20 opacity-60">
                    <span className="font-mono text-xs tracking-widest">
                        {formatTime(time)} <span className="text-[10px] align-top">UTC-5</span>
                    </span>
                    <div className="flex items-center gap-2 text-[10px] font-mono tracking-widest mt-1">
                        <span>34.0522° N</span>
